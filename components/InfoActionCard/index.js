			...
			<div className="nfd-flex nfd-items-center nfd-space-x-2">
				...
				{ infoText && (
					<InformationCircleIcon
						className="nfd-h-4 nfd-w-4 nfd-text-gray-500"
						title={ infoText }
					/>
				) }
			</div>
			...
			<div className="nfd-mt-3">
				{ items.map(
					(
						...
						<div
							key={ index }
							className="nfd-relative nfd-flex nfd-justify-between nfd-items-center nfd-mb-2"
						>
							<div className="nfd-flex nfd-items-center nfd-space-x-2">
								{ label && (
								...
								<p className="nfd-text-gray-700">{ value }</p>
							</div>
							{ actionText && (
